...
export function ItemSelect({ items, value, onValueChange, placeholder = "Select item...", disabled }: ItemSelectProps) {
    ...
    <Popover open={open} onOpenChange={setOpen}>
            ...
            {selectedItem ? (
              <span className="flex items-center gap-2">
                ...
                {selectedItem.itemCode && (
                  <span className="text-xs text-muted-foreground">({selectedItem.itemCode})</span>
                )}
              </span>
            ) : (
      ...
      <PopoverContent className="w-[400px] p-0" align="start">
        <Command shouldFilter={false}>
          <CommandInput placeholder="Search items by name, code, HSN, or category..." value={searchQuery} onValueChange={setSearchQuery} />
          <CommandList>
