  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
        ...
        <Card style={styles.overviewCard}>
          ...
          <View style={styles.overviewStat}>
            <Text style={[styles.overviewValue, { color: colors.primary }]}>
              {customers.filter((c) => c.gst_number || c.gstin).length}
            </Text>
      ...
      <FlatList
        ...
        contentContainerStyle={[styles.listContent, customers.length === 0 && styles.listContentEmpty]}
...
const styles = StyleSheet.create({
  ...
  cardInfo: { flex: 1 },
  customerName: { fontSize: 15, fontWeight: '600', marginBottom: 3, letterSpacing: -0.2, lineHeight: 20 },
