...
import { LayoutDashboard, Users, Package, FileText, Settings, Menu, X, ShoppingCart, Truck } from "lucide-react"
...
export function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed top-0 left-0 z-40 h-screen bg-sidebar border-r border-sidebar-border transition-transform lg:translate-x-0",
