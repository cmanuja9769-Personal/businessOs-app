...
export default async function ReportsPage() {
  ...
  // Total collected calculation available if needed
  ...
  return (
    <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
      ...
      <Tabs defaultValue="sales" className="space-y-4">
                ...
                <TableBody>
                  {topItems.length === 0 ? (
                    ...
                    topItems.map((item, index) => (
                      <TableRow key={index}>
                        <TableCell className="font-medium">{item.item?.itemName || "Unknown Item"}</TableCell>
        ...
        {/* Stock Summary Report - New Comprehensive Report */}
